    ...
    return (
        ...
        >
            ...
            <MotionFlex
                gap="80px"
                variants={{
                    hidden: { opacity: 0, x: -100 },  // Se desliza desde la izquierda
            ...
            >
                ...
                <MotionFlex
                    ...
                    position="relative"
                    variants={{
                        hidden: { opacity: 0, scale: 1 },  // Aparece más pequeña y con opacidad
                ...
                <MotionFlex
                    ...
                    maxW="450px"
                    variants={{
                        hidden: { opacity: 0, x: 100 },  // Se desliza desde la derecha
                        visible: { opacity: 1, x: 0, transition: { duration: 1, ease: "easeOut" } },
                    }}
                >
                    ...
                    <MotionButton
                        ...
                        fontWeight="500"
                        variants={{
                            hidden: { opacity: 0, y: 20 },  // El botón se desliza ligeramente hacia arriba
            ...
            >
                ...
                <MotionFlex
                    ...
                    gap="30px"
                    variants={{
                        hidden: { opacity: 0, x: -50 },  // Aparece desde la izquierda
                        visible: { opacity: 1, x: 0, transition: { duration: 1, ease: "easeOut" } },
                    }}
                >
                    ...
                    <Text fontSize="14px" fontWeight="400" color="secondary_font">
                ...
                <MotionFlex
                    ...
                    gap="30px"
                    variants={{
                        hidden: { opacity: 0, x: 50 },  // Aparece desde la derecha
                        visible: { opacity: 1, x: 0, transition: { duration: 1, ease: "easeOut" } },
                    }}
                >
                    <Text fontSize="21px" fontWeight="600">
